...
struct ProcessHelper
{
	...
	sync::Event ResumeEventForDelete;
	...
	BOOLEAN IsSuspendedForDelete() { return ResumeEventForDelete.Valid() ? !ResumeEventForDelete.IsSet() : false; }

	const HANDLE GetPid() const { return Pid; }
	const HANDLE GetParentPid() const { return ParentPid; }
};
